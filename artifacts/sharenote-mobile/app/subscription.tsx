      ...
      <ScrollView contentContainerStyle={[styles.content, { paddingBottom: insets.bottom + 36 }]} showsVerticalScrollIndicator={false}>
        <View style={[styles.hero, { backgroundColor: colors.primary }]}>
          ...
          <Text style={[styles.heroBody, { color: colors.primaryForeground, fontFamily: 'Inter_400Regular' }]}>
            {isBypassMode
              ? 'The development-only subscription bypass is on. RevenueCat remains required in release builds.'
              : isSubscribed
        ...
        {isBypassMode ? (
          <View style={[styles.messageCard, { backgroundColor: colors.card }]}>
            <Text style={[styles.messageTitle, { color: colors.foreground, fontFamily: 'Inter_600SemiBold' }]}>RevenueCat bypass is on</Text>
            <Text style={[styles.muted, { color: colors.mutedForeground }]}>Turn off EXPO_PUBLIC_REVENUECAT_BYPASS and restart the app to test purchases.</Text>
          </View>
        ) : isLoading ? (
